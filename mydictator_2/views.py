...
class Introduction(Page):
    def vars_for_template(self):
        intro_text = "mydictator_2/Instructions.html"

        if self.player.id_in_group > 1:
            intro_text= "mydictator_2/Instructions_2.html"

        return {
            'introduction': intro_text,
            'allocation2': self.player.participant.vars['randnumber2'] * 10,
        }
...
class Offer(Page):
    ...
    def vars_for_template(self):
        return {'allocation2': self.player.participant.vars['randnumber2'] * 10,
        }
