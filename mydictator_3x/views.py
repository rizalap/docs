...
class Introduction(Page):
    def vars_for_template(self):
        intro_text = "mydictator_3x/Instructions.html"

        if self.player.id_in_group > 1:
            intro_text= "mydictator_3x/Instructions_2.html"

        return {
            'introduction': intro_text,
            'allocation3x': self.player.participant.vars['randnumber3x'] * 10,
        }
...
class Offer(Page):
    ...
    def vars_for_template(self):
        ...
        return {'allocation3x': self.player.participant.vars['randnumber3x'] * 10,
        }
