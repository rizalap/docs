...
class Introduction(Page):
    def vars_for_template(self):
        intro_text = "mydictator_example/Instructions.html"

        if self.player.id_in_group > 1:
            intro_text= "mydictator_example/Instructions_2.html"

        return {
            'introduction': intro_text,
            'allocation_edit': self.player.participant.vars['randnumber_edit'] * 10,
        }
...
class Offer(Page):
    ...
    def vars_for_template(self):
        return {'allocation_edit': self.player.participant.vars['randnumber_edit'] * 10,
        }
