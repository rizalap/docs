...
class Introduction(Page):
    def vars_for_template(self):
        intro_text = "mydictator_2b/Instructions.html"

        if self.player.id_in_group > 1:
            intro_text= "mydictator_2b/Instructions_2.html"

        return {
            'introduction': intro_text,
            'allocation2b': self.player.participant.vars['randnumber2b'] * 10,
        }
...
class Offer(Page):
    ...
    def vars_for_template(self):
        return {'allocation2b': self.player.participant.vars['randnumber2b'] * 10,
        }
